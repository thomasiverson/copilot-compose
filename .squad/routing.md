...
|-----------|----------|----------|
| Architecture, system design | Morpheus | Master repo structure, extension ↔ action design, composable instruction format |
| VS Code extension | Neo | Extension commands, UI, settings, activation, webviews |
| GitHub Actions, CI/CD, sync | Trinity | Workflows, automation, GitHub API, sync logic |
| Code review | Morpheus | Review PRs, check quality, suggest improvements |
| Testing | Tank | Write tests, find edge cases, verify extension + action behavior |
| Documentation, guides | Oracle | README, setup guides, contribution docs, user-facing docs |
